...
const Experience = ({experienceRef}) => {
    ...
    return (
        <><Flex ref={experienceRef} position={'relative'}
                style={!isMobile && viewportHeight >= 665 ? {scrollSnapAlign: 'start', height: '100vh'} : null}
                flexDir="column" justify="center" alignItems="center" spacing="20" w="75%" m="auto" py={'30px'}
                pt={isMobile ? 0 : '30px'} zIndex={1}>
            <Grid position={'relative'} templateColumns={columnLayout} templateRows='repeat(5, 1fr)' gap={2}>
                ...
                <GridItem
                    ...
                    <Box textAlign={isMobile ? "justify" : "left"}>
                        <Heading py={'10px'} textAlign={'left'} bg="white" size={'md'}>Rohlik.cz Shopping Automation
                            Project</Heading>
            ...
            <Grid mt={'40px'} position={'relative'} templateColumns={columnLayout}
                ...
                <GridItem
                    ...
                    style={{minWidth: '200px'}}>
                    <Box textAlign={isMobile ? "justify" : "right"}>
                        <Heading py={'10px'} textAlign={isMobile ? 'left' : 'right'} bg="white" size={'md'}>ReactGirls
                            Academy - Bomberman</Heading>
                        <Text bg="white">A JavaScript project featuring a fully functional classic game developed during
                            my
                ...
                <GridItem
                    ...
                    style={{minWidth: '200px'}}>
                    <Box textAlign={isMobile ? "justify" : "right"}>
                        <Heading py={'10px'} textAlign={isMobile ? "left" : "right"} bg="white" size={'md'}>Google
                            Cybersecurity Professional Certificate</Heading>
                        <Text bg="white">Python | Linux | SQL | Security Information and Event Management (SIEM) tools.
                            In progress, to be finished by December.</Text>
                    </Box>
                </GridItem>
                <GridItem
                    colSpan={isMobile ? 1 : 3}
